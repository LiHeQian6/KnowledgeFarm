...
bool Shop::init() {
	...
	jiantou->setPosition(Vec2(orgin.x + visibleSize.width * 0.03, orgin.y + visibleSize.height * 0.85));
...
void Shop::menuJiantouCallback(Ref* pSender) {
	Director::sharedDirector()->pushScene(TransitionMoveInL::create(0.3, Learn::createScene()));
}